...
$std->findOnProfile_id($_REQUEST['std-prof_id']);
...
$pdf->AddExp(students_exp::getAllStudents_exp(' profile_id='.$_REQUEST['std-prof_id']));
$pdf->AddEdu($std,students_edu::getAllStudents_edu(' profile_id='.$_REQUEST['std-prof_id']));
$pdf->AddProjects(students_projects::getAllStudents_projects(' profile_id='.$_REQUEST['std-prof_id']));
$pdf->AddProfDev(students_prof_dev::getAllStudents_prof_dev(' profile_id='.$_REQUEST['std-prof_id']));
$pdf->AddLeader(students_leadership::getAllStudents_leadership(' profile_id='.$_REQUEST['std-prof_id']));

$pt = new students_tech();
$pt->findOnTech_id($std->getTech_id());
$pdf->AddTech($pt);
$pdf->AddAchiev(achievements::getAllAchievements(' profile_id='.$_REQUEST['std-prof_id']));
$pdf->AddeXtra($std);
$pdf->AddRef(students_ref::getAllStudents_ref(' profile_id='.$_REQUEST['std-prof_id']));
